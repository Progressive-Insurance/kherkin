...
class BasicComposeActivity : ComponentActivity() {
    ...
    private fun SetupContent() {
        Column {
            ...
            BasicButton()
            HidingButton(
                buttonIsVisible = buttonVisibility,
                changeValue = { buttonVisibility = it })
            NavButton()
            TextField()
            TextFieldPrefilled()
            ScrollBoxes()
    ...
    private fun NavButton() {
        val buttonText = stringResource(id = R.string.nav_button)
        val text by remember { mutableStateOf(buttonText) }
        Button(
            onClick = {
